...
public class WeightedCompanionCubeEntity extends Entity implements GeoEntity
{
	...
	private static final EntityDataAccessor<Integer> ACTIVE_COLOR = SynchedEntityData.defineId(
			WeightedCompanionCubeEntity.class, EntityDataSerializers.INT);
	...
	public InteractionResult interact(Player player, InteractionHand hand)
	{
		...
		if(stack.isEmpty() && !player.isCrouching())
		{
			player.openMenu(new SimpleMenuProvider(
					...
					Component.translatable("container.aperture_innovations.weighted_companion_cube")));
		...
		if(stack.isEmpty() && player.isCrouching())
		{
			...
			ItemEntity item = new ItemEntity(player.level(), this.getX(), this.getY(), this.getZ(),
					ItemInit.WEIGHTED_COMPANION_CUBE.get().getDefaultInstance());
