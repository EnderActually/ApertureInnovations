...
/*
 * Huge thanks to Povstalec for such an awesome energy implementation
 */
public abstract class ItemEnergyProvider implements ICapabilityProvider
{
	...
	public void loadEnergy()
	{
		...
		if(tag.contains(ENERGY, Tag.TAG_LONG)) ENERGY_STORAGE.deserializeNBT(tag.get(ENERGY));
	}
	...
	public void saveEnergy()
	{
		if(ENERGY_STORAGE.getEnergyWithoutLoading() > 0)
		{
			...
			stack.setTag(tag);
		} else if(stack.getTag() != null && stack.getTag().contains(ENERGY)) stack.removeTagKey(ENERGY);
	}
}
